...
print "###################################"
print "MODIFIED VERSION OF MONKEYRUNNER.PY"
print "###################################"
...
p = subprocess.Popen(["adb", "shell", "monkey", "-p", package, "-v", "10000"], stdout=subprocess.PIPE)
# output = subprocess.check_output(('ps', package+""), stdin=subprocess.PIPE)

print "Process in background"

# print "SUBPROCESS IN BACKGROUND"
